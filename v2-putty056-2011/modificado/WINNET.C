...
char *winsock_error_string(int error)
{
    switch (error) {
      case WSAEACCES:
	return "Erro na rede: Permissão negada";
      case WSAEADDRINUSE:
	return "Erro na rede: Address already in use";
      case WSAEADDRNOTAVAIL:
	return "Erro na rede: Cannot assign requested address";
      case WSAEAFNOSUPPORT:
	return
	    "Erro na rede: Address family not supported by protocol family";
      case WSAEALREADY:
	return "Erro na rede: Operation already in progress";
      case WSAECONNABORTED:
	return "Erro na rede: Seu sistema abortou a comunicação, verifique o cabo de rede.";
      case WSAECONNREFUSED:
	return "Erro na rede: Conexão negada";
      case WSAECONNRESET:
	return "Erro na rede: Conexão reiniciada";
      case WSAEDESTADDRREQ:
	return "Erro na rede: Destination address required";
      case WSAEFAULT:
	return "Erro na rede: Bad address";
      case WSAEHOSTDOWN:
	return "Erro na rede: Servidor desligado";
      case WSAEHOSTUNREACH:
	return "Erro na rede: Não foi possivel alcançar o servidor";
      case WSAEINPROGRESS:
	return "Erro na rede: Operation now in progress";
      case WSAEINTR:
	return "Erro na rede: Interrupted function call";
      case WSAEINVAL:
	return "Erro na rede: Invalid argument";
      case WSAEISCONN:
	return "Erro na rede: Socket is already connected";
      case WSAEMFILE:
	return "Erro na rede: Too many open files";
      case WSAEMSGSIZE:
	return "Erro na rede: Message too long";
      case WSAENETDOWN:
	return "Erro na rede: Caiu a conexão";
      case WSAENETRESET:
	return "Erro na rede: Network dropped connection on reset";
      case WSAENETUNREACH:
	return "Erro na rede: Não foi possível conectar no servidor";
      case WSAENOBUFS:
	return "Erro na rede: No buffer space available";
      case WSAENOPROTOOPT:
	return "Erro na rede: Bad protocol option";
      case WSAENOTCONN:
	return "Erro na rede: Socket is not connected";
      case WSAENOTSOCK:
	return "Erro na rede: Socket operation on non-socket";
      case WSAEOPNOTSUPP:
	return "Erro na rede: Operation not supported";
      case WSAEPFNOSUPPORT:
	return "Erro na rede: Protocol family not supported";
      case WSAEPROCLIM:
	return "Erro na rede: Too many processes";
      case WSAEPROTONOSUPPORT:
	return "Erro na rede: Protocol not supported";
      case WSAEPROTOTYPE:
	return "Erro na rede: Protocol wrong type for socket";
      case WSAESHUTDOWN:
	return "Erro na rede: Cannot send after socket shutdown";
      case WSAESOCKTNOSUPPORT:
	return "Erro na rede: Socket type not supported";
      case WSAETIMEDOUT:
	return "Erro na rede: Tempo para conexão esgotado";
      case WSAEWOULDBLOCK:
	return "Erro na rede: Resource temporarily unavailable";
      case WSAEDISCON:
	return "Erro na rede: Graceful shutdown in progress";
      default:
