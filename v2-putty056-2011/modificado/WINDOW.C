...
/*MEXIDAMINHA*/
#define IDM_MEU_RELATORIOS     0x0070
/*MEXIDAMINHA*/
#define IDM_MEU_HELP     0x0080
#define IDM_MEU_SUPORTE  0x0090
#define IDM_MEU_PORTAL   0x0100
#define IDM_MEU_TERMSEG  0x0110
...
int WINAPI WinMain(HINSTANCE inst, HINSTANCE prev, LPSTR cmdline, int show)
{
    ...
    if (!init_winver())
    {
	char *str = dupprintf("%s  - Alerta de Erro", appname);
	...
	//    AppendMenu(m, MF_SEPARATOR, 0, 0);
	    AppendMenu(m, (cfg.resize_action == RESIZE_DISABLED) ?
		       MF_GRAYED : MF_ENABLED, IDM_FULLSCREEN, "&Tela cheia (alt+enter)");
...
void connection_fatal(void *frontend, char *fmt, ...)
{
    ...
    va_end(ap);
    sprintf(morestuff, "%.70s  - Alerta de Erro", appname);
				...
				WPARAM wParam, LPARAM lParam)
{
      ...
      case WM_CLOSE:
	{
	    char *str;
	    show_mouseptr(1);
	    str = dupprintf("Confirmação de saída", appname);
