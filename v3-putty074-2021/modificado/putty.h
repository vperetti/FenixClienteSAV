...
struct TermWinVtable {
	...
	bool (*ShellExecuteA) (TermWin *tw, wchar_t lpOperation, wchar_t lpFile, wchar_t lpParameters, wchar_t lpDirectory, int nShowCmd); /*MEXIDAMINHA*/
...
static inline bool win_ShellExecuteA(TermWin *win, wchar_t lpOperation, wchar_t lpFile, wchar_t lpParameters,wchar_t lpDirectory, int nShowCmd) /*MEXIDAMINHA*/
{ return win->vt->ShellExecuteA(win, lpOperation, lpFile, lpParameters, lpDirectory, nShowCmd); }/*MEXIDAMINHA*/
