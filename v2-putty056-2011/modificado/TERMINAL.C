...
static void term_print_flush(Terminal *term)
{
	...
	/*MEXIDAMINHA*/
	nMINHA_URL = strlen(MINHA_URL);

	if (
			(
					(nMINHA_URL == 0)&(strncmp(cHttp, data, 4)!=0)
			)
			|
			(strncmp(cHttp, MINHA_URL, 4)!=0)
		){
...
static void term_print_finish(Terminal *term)
{
    ...
    /*MEXIDAMINHA*/
    char* cHttp = "http";
    char* cFenixReport = "httpjr";
    char* cFenixReportView = "C:\\fenixReport\\fenixReportView.bat ";
    ...
    /*MEXIDAMINHA*/
    /*
    if (strncmp(cHttp, MINHA_URL, 4)==0){
       ShellExecute(term->frontend, "open",  MINHA_URL,  0, 0, SW_SHOWDEFAULT);
    }*/

    /*MEXIDAMINHA*/
    /*
    if (strncmp(cFenixReport, MINHA_URL, 4)==0){
           ShellExecute(term->frontend, "open",  MINHA_URL,  0, 0, SW_SHOWDEFAULT);
    }*/
    if (strncmp(cFenixReport, MINHA_URL, 6)==0){
      // ShellExecute(term->frontend, "open",  MINHA_URL,  0, 0, SW_SHOWDEFAULT);

    	//WinExec(strcat("javaw -cp c:\FenixReport\lib\barbecue-1.5-beta1.jar;c:\FenixReport\lib\barcode4j-2.0.jar;c:\FenixReport\lib\batik-anim.jar;c:\FenixReport\lib\batik-awt-util.jar;c:\FenixReport\lib\batik-bridge.jar;c:\FenixReport\lib\batik-css.jar;c:\FenixReport\lib\batik-dom.jar;c:\FenixReport\lib\batik-ext.jar;c:\FenixReport\lib\batik-gvt.jar;c:\FenixReport\lib\batik-parser.jar;c:\FenixReport\lib\batik-script.jar;c:\FenixReport\lib\batik-svg-dom.jar;c:\FenixReport\lib\batik-svggen.jar;c:\FenixReport\lib\batik-util.jar;c:\FenixReport\lib\batik-xml.jar;c:\FenixReport\lib\bcmail-jdk15-146.jar;c:\FenixReport\lib\bcprov-jdk15-146.jar;c:\FenixReport\lib\bctsp-jdk15-146.jar;c:\FenixReport\lib\castor-1.2.jar;c:\FenixReport\lib\commons-beanutils-1.8.2.jar;c:\FenixReport\lib\commons-collections-3.2.1.jar;c:\FenixReport\lib\commons-digester-1.7.jar;c:\FenixReport\lib\commons-logging-1.1.jar;c:\FenixReport\lib\groovy-all-1.7.5.jar;c:\FenixReport\lib\iText-2.1.7.jar;c:\FenixReport\lib\itext-asiancmaps.jar;c:\FenixReport\lib\itext-asian.jar;c:\FenixReport\lib\iTextAsian.jar;c:\FenixReport\lib\itext-hyph-xml.jar;c:\FenixReport\lib\itextpdf-5.1.0.jar;c:\FenixReport\lib\itext-xtra-5.1.0.jar;c:\FenixReport\lib\jakarta-bcel-20050813.jar;c:\FenixReport\lib\jasperreports-4.0.2.jar;c:\FenixReport\lib\jaxen-1.1.1.jar;c:\FenixReport\lib\jcommon-1.0.15.jar;c:\FenixReport\lib\jfreechart-1.0.12.jar;c:\FenixReport\lib\jpa.jar;c:\FenixReport\lib\jxl-2.6.10.jar;c:\FenixReport\lib\png-encoder-1.5.jar;c:\FenixReport\lib\poi-3.6.jar;c:\FenixReport\lib\rhino-1.7R1.jar;c:\FenixReport\lib\xalan.jar;c:\FenixReport\lib\xml-apis-ext.jar;c:\FenixReport\lib\xml-apis.jar -jar c:\fenixReport\fenixReport.jar toViewRemote ",MINHA_URL), SW_SHOWNORMAL);
    	//"-cp c:\FenixReport\lib\barbecue-1.5-beta1.jar;c:\FenixReport\lib\barcode4j-2.0.jar;c:\FenixReport\lib\batik-anim.jar;c:\FenixReport\lib\batik-awt-util.jar;c:\FenixReport\lib\batik-bridge.jar;c:\FenixReport\lib\batik-css.jar;c:\FenixReport\lib\batik-dom.jar;c:\FenixReport\lib\batik-ext.jar;c:\FenixReport\lib\batik-gvt.jar;c:\FenixReport\lib\batik-parser.jar;c:\FenixReport\lib\batik-script.jar;c:\FenixReport\lib\batik-svg-dom.jar;c:\FenixReport\lib\batik-svggen.jar;c:\FenixReport\lib\batik-util.jar;c:\FenixReport\lib\batik-xml.jar;c:\FenixReport\lib\bcmail-jdk15-146.jar;c:\FenixReport\lib\bcprov-jdk15-146.jar;c:\FenixReport\lib\bctsp-jdk15-146.jar;c:\FenixReport\lib\castor-1.2.jar;c:\FenixReport\lib\commons-beanutils-1.8.2.jar;c:\FenixReport\lib\commons-collections-3.2.1.jar;c:\FenixReport\lib\commons-digester-1.7.jar;c:\FenixReport\lib\commons-logging-1.1.jar;c:\FenixReport\lib\groovy-all-1.7.5.jar;c:\FenixReport\lib\iText-2.1.7.jar;c:\FenixReport\lib\itext-asiancmaps.jar;c:\FenixReport\lib\itext-asian.jar;c:\FenixReport\lib\iTextAsian.jar;c:\FenixReport\lib\itext-hyph-xml.jar;c:\FenixReport\lib\itextpdf-5.1.0.jar;c:\FenixReport\lib\itext-xtra-5.1.0.jar;c:\FenixReport\lib\jakarta-bcel-20050813.jar;c:\FenixReport\lib\jasperreports-4.0.2.jar;c:\FenixReport\lib\jaxen-1.1.1.jar;c:\FenixReport\lib\jcommon-1.0.15.jar;c:\FenixReport\lib\jfreechart-1.0.12.jar;c:\FenixReport\lib\jpa.jar;c:\FenixReport\lib\jxl-2.6.10.jar;c:\FenixReport\lib\png-encoder-1.5.jar;c:\FenixReport\lib\poi-3.6.jar;c:\FenixReport\lib\rhino-1.7R1.jar;c:\FenixReport\lib\xalan.jar;c:\FenixReport\lib\xml-apis-ext.jar;c:\FenixReport\lib\xml-apis.jar "
    	 //strcat(cFenixReportView,MINHA_URL);
    	 //WinExec(cFenixReportView, SW_SHOWNORMAL);
    	 //ShellExecute(term->frontend, "open",  cFenixReportView,  0, 0, SW_SHOWDEFAULT);
    	 ShellExecute(term->frontend, "open",  "fenixReport.jar", MINHA_URL,  "c:\\Fenix\\" , SW_SHOWDEFAULT);
    }
    else if (strncmp(cHttp, MINHA_URL, 4)==0){
       ShellExecute(term->frontend, "open",  MINHA_URL,  0, 0, SW_SHOWDEFAULT);
    }
