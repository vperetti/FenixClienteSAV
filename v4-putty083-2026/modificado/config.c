                      ...
                      int protocol, int protcfginfo)
{
     ...
     * The Session panel.
     */
    str = dupprintf("Op\xe7\xf5" "es b\xe1" "sicas para sess\xe3" "o %s ", appname);
    ctrl_settitle(b, "Sess\xe3" "o", str);
    sfree(str);
    ...
    if (!midsession) {
        ...
        s = ctrl_getset(b, "Conex\xe3" "o", "hostport",
                        "Informe o host name ou endere\xe7" "o IP do servidor");
        ...
        c = ctrl_text(s, "Tipo de Conex\xe3" "o:", HELPCTX(session_hostname));
     ...
     */
    s = ctrl_getset(b, "Sess\xe3" "o", "savedsessions",
                    midsession ? "Save the current session settings" :
                    "Carregue, salve ou delete uma sess\xe3" "o");
    ctrl_columns(s, 2, 75, 25);
    get_sesslist(&ssd->sesslist, true);
    ssd->editbox = ctrl_editbox(s, "Sess\xf5" "es Salvas", 'e', 100,
...
#if 0 /* MEXIDAMINHA: DISABLE EXTRA PANELS */
    ...
    s = ctrl_getset(b, "Impress\xe3" "o", "printing", "Controle de Impressora");
