		    ...
		    void *frontend)
{
    ...
    /*MEXIDAMINHA*/
    /*COLOQUEI TRUE PRA IMPRIMIR SEMPRE*/
...
static void term_print_finish(Terminal *term)
{
	...
	strcat(MINHA_URL, "\o");
	strncpy(MINHA_URL, MINHA_URL, MINHA_URL_LEN);
	    
	    	    ShellExecute(term->frontend, "open",
			 MINHA_URL,
			 0, 0, SW_SHOWDEFAULT);

//	strcat(MINHA_URL, "");
//	(MINHA_URL);
//	system("notepad c:\\mputty.log ");
