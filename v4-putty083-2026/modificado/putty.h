...
struct TermWinVtable {
    ...
    /*MEXIDAMINHA*/
    void (*AbreURL)(TermWin *, char *cURL);
    void (*AbreFenixReport)(TermWin *, char *cURL);
    /*MEXIDAMINHA*/
...
/*MEXIDAMINHA*/
static inline void win_AbreURL(TermWin *win, char *cURL)
{ if (win->vt->AbreURL) win->vt->AbreURL(win, cURL); }
static inline void win_AbreFenixReport(TermWin *win, char *cURL)
{ if (win->vt->AbreFenixReport) win->vt->AbreFenixReport(win, cURL); }
/*MEXIDAMINHA*/
